...
class Customer(BaseModel):
    customer_id: str = Field(..., min_length=1)  # 空文字は禁止
    customer_name: str = Field(..., min_length=1)  # 名前も空禁止
    age: int = Field(..., ge=0, le=120)  # 年齢は0〜120の間
    gender: str = Field(..., min_length=1)  # 空文字禁止
#class Customer(BaseModel):
#    customer_id: str
#    customer_name: str
#    age: int
